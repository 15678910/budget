      ...
      <div className="border border-gray-800 p-4 md:p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
          <Slider
            ...
            unit="%"
            color="text-blue-400"
            tooltip="지역 예산 중 공공주택 건설에 투입하는 비율. 높을수록 더 많은 주택 건설 가능"
          ...
          <Slider
            ...
            tooltip="저출산 예산의 공공주택 전환 비중. 현금 수당 대신 주택 건설에 투입하는 비율"
          ...
          <Slider
            ...
            tooltip="공공주택 1호 건설 비용 (토지+건축+부대비, 60㎡ 기준). 낮을수록 같은 예산으로 더 많이 건설"
          ...
          <Slider
            ...
            unit="%"
            color="text-blue-400"
            tooltip="공공은행 저리대출로 인한 건설비 절감율. 시중 대비 2~3%p 낮은 금리 효과 반영"
          ...
          <Slider
            ...
            tooltip="건설된 공공주택의 수도권 배분 비율. 나머지는 비수도권에 배정"
