...
import { SDGImpactDashboard } from './SDGImpactDashboard';
  ...
  return (
    <div ref={contentRef} className="bg-gray-950 text-gray-300 w-full min-h-screen p-2 md:p-4 space-y-1">
        ...
        <div className="space-y-2">
          {chartData.map((d) => (
            <div key={d.year} className="flex items-center gap-3 py-1">
              ...
              <span className="text-sm md:text-base text-gray-400 w-20 text-right font-mono">
                {d.fundSize >= 1000 ? `${(d.fundSize / 1000).toFixed(1)}천조` : `${d.fundSize.toFixed(0)}조`}
              </span>
              <span className="text-sm md:text-base text-emerald-400 w-24 text-right font-mono">
      ...
      <InfoSection title="노르웨이 국부펀드 운용 방식 상세 Norway GPFG Details" color="text-teal-400">
        ...
        <div>
          <h4 className="text-base md:text-base font-bold text-gray-300 mb-1.5">재원 조달</h4>
        ...
        <div>
          <h4 className="text-base md:text-base font-bold text-gray-300 mb-1.5">운용 전략</h4>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="border border-gray-800 p-3 rounded">
              <div className="text-sm text-gray-500 mb-1">자산배분</div>
              <div className="text-base font-mono text-gray-300">주식 70% / 채권 27% / 부동산 3%</div>
            </div>
            <div className="border border-gray-800 p-3 rounded">
              <div className="text-sm text-gray-500 mb-1">투자 지역</div>
              <div className="text-base font-mono text-gray-300">전 세계 70개국, 9,000개+ 기업</div>
            </div>
            <div className="border border-gray-800 p-3 rounded">
              <div className="text-sm text-gray-500 mb-1">연평균 수익률</div>
              <div className="text-base font-mono text-gray-300">6.3% (1998~2023 실질)</div>
            </div>
          </div>
        </div>

        <div>
          <h4 className="text-base md:text-base font-bold text-gray-300 mb-1.5">재정 준칙 (Fiscal Rule)</h4>
        ...
        <div>
          <h4 className="text-base md:text-base font-bold text-gray-300 mb-1.5">거버넌스</h4>
          <ul className="list-disc list-inside space-y-1 text-gray-500">
        ...
        <div className="border-t border-gray-800 pt-3">
          <h4 className="text-base md:text-base font-bold text-gray-300 mb-1.5">한국에 적용한다면?</h4>
          <p className="text-gray-500">
      ...
      <InfoSection title="시뮬레이션 전제 조건 Simulation Assumptions" color="text-blue-400">
        <div>
          <h4 className="text-base md:text-base font-bold text-gray-300 mb-1.5">기본 가정</h4>
          <div className="space-y-2">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-base">중앙정부 예산 728조원 + 공공기관(공기업·준정부·기타) 772조원. 2026년 기준.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-base">효율화 절감액은 먼저 재정적자 보전에 사용됩니다. 적자 해소 후 잔여분만 펀드에 적립합니다.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-base">109조 ÷ 1,500조 ≈ 7.3%. 효율화율이 이 수치를 넘어야 펀드 적립이 시작됩니다.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-base">매년 (전년 펀드잔액 × 수익률) + 신규 적립금으로 누적. 복리 효과로 장기 운용 시 기하급수적 성장.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-base">펀드 × 인출률 = 연간 인출액. 이를 인구 {(POPULATION / 10000).toFixed(0)}만명으로 나눠 1인당 월 기본소득 산출.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <InfoSection title="파라미터 해설 Parameter Guide" color="text-purple-400">
        <div className="space-y-4">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-2">
              <div className="border border-gray-800 p-2 rounded">
                <div className="text-sm text-gray-500">보수적 (3~5%)</div>
                <div className="text-base text-gray-400">단순 행정 자동화, 중복 업무 제거</div>
              </div>
              <div className="border border-gray-800 p-2 rounded">
                <div className="text-sm text-amber-400">중간 (7~10%)</div>
                <div className="text-base text-gray-400">AI 도입, 기관 통합, 디지털 전환</div>
              </div>
              <div className="border border-gray-800 p-2 rounded">
                <div className="text-sm text-emerald-400">적극적 (10~15%)</div>
                <div className="text-base text-gray-400">전면적 AI 행정, 조직 재설계</div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-500 text-base">연간 투자 수익률. 글로벌 분산투자 기준.</p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-2">
              <div className="border border-gray-800 p-2 rounded">
                <div className="text-sm text-gray-500">보수적 (3~5%)</div>
                <div className="text-base text-gray-400">채권 위주, 국민연금 수준</div>
              </div>
              <div className="border border-gray-800 p-2 rounded">
                <div className="text-sm text-amber-400">노르웨이 GPFG 실적 (~6.3%)</div>
                <div className="text-base text-gray-400">주식 70%, 채권 27%, 부동산 3%</div>
              </div>
              <div className="border border-gray-800 p-2 rounded">
                <div className="text-sm text-emerald-400">적극적 (8~12%)</div>
                <div className="text-base text-gray-400">주식 비중 확대, 대체투자 포함</div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-2">
              <div className="border border-gray-800 p-2 rounded">
                <div className="text-sm text-emerald-400">영구 지속 가능 (3%)</div>
                <div className="text-base text-gray-400">노르웨이 방식. 원금 보존, 실질수익률 이하 인출</div>
              </div>
              <div className="border border-gray-800 p-2 rounded">
                <div className="text-sm text-amber-400">균형 (4%)</div>
                <div className="text-base text-gray-400">&quot;4% 룰&quot;. 미국 은퇴 연구 기반, 30년 지속 가능</div>
              </div>
              <div className="border border-gray-800 p-2 rounded">
                <div className="text-sm text-red-400">적극 인출 (5~6%)</div>
                <div className="text-base text-gray-400">높은 분배, 원금 소진 위험 있음</div>
              </div>
            </div>
          </div>
        </div>
