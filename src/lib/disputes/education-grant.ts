...
export const educationGrant: Dispute = {
  ...
  caveats: [
    ...
    '기획예산처 「100대 신규사업」에서 교육 관련 신규사업은 5건, 2027년 1조 670억원이다. 대학생 첫경력 프로젝트 4,650억원, 지역 균형발전 장학금 3,280억원, AI 재도약 대학 2,070억원, 대학 창업 교육 470억원, 대학생 AI 공동구독 200억원 — 다섯 건 모두 대학 사업이고 초·중등 사업은 없다. 또한 이 가운데 셋은 2~3년 한시사업인 반면, 교부금 산식 변경은 법률에 영구히 남는다.',
